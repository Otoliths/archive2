...
water <- jsonlite::fromJSON("http://www.ynswj.cn/webapi/api/v1/water?extra=area&itm=1&area_code=530000&no_data_visible=false",fill_na = TRUE)
...
rain <- jsonlite::fromJSON("http://www.ynswj.cn/webapi/api/v1/rain?extra=area&itm=1&area_code=530000&no_data_visible=false",fill_na = TRUE)
